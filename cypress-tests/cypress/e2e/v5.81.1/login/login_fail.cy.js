...
context('Error en inicio de sesion por email y contraseña incorrecta.', () => {
  ...
  it('Iniciar sesión fallido con campo password vacio', () => {
    ...
    cy.screenshot('../screenshots/login_fail/before_3');
    cy.wait(500);

     // Seleccioanr el boton de inicio de sesion.
     cy.get('button[type="submit"]').click();
     cy.screenshot('../screenshots/login_fail/before_4');
     cy.wait(500);

    // El boton debe contener el mensaje "Retry"
    cy.get('span[data-test-task-button-state="failure"]').should('contain','Retry');
    cy.screenshot('../screenshots/login_fail/before_5');
    cy.wait(500);
    // Visualizo mensaje de error.
    cy.get('p[class="main-error"]').should('contain',errors.empty_form);
    cy.screenshot('../screenshots/login_fail/before_6');
    cy.wait(500);
  })
  ...
  it('Iniciar sesión fallido con campo email vacio', () => {
    ...
    cy.screenshot('../screenshots/login_fail/before_7');
    cy.wait(500);

     // Seleccioanr el boton de inicio de sesion.
     cy.get('button[type="submit"]').click();
     cy.screenshot('../screenshots/login_fail/before_8');
     cy.wait(500);

    // El boton debe contener el mensaje "Retry"
    cy.get('span[data-test-task-button-state="failure"]').should('contain','Retry');
    cy.screenshot('../screenshots/login_fail/before_9');
    cy.wait(500);
    // Visualizo mensaje de error.
    cy.get('p[class="main-error"]').should('contain',errors.empty_form);
    cy.screenshot('../screenshots/login_fail/before_10');
    cy.wait(500);
  })
  ...
  it('Iniciar sesión fallido con email invalido y password incorrecto', () => {
    ...
    cy.screenshot('../screenshots/login_fail/before_11');
    cy.wait(500);
    
    // Seleccionar el campo del password e ingresar un valor.
    cy.get('input[id="password"]').type(user.invalid_password);
    cy.screenshot('../screenshots/login_fail/before_12');
    cy.wait(500);

     // Seleccioanr el boton de inicio de sesion.
     cy.get('button[type="submit"]').click();
     cy.screenshot('../screenshots/login_fail/before_13');
     cy.wait(500);

    // El boton debe contener el mensaje "Retry"
    cy.get('span[data-test-task-button-state="failure"]').should('contain','Retry');
    cy.screenshot('../screenshots/login_fail/before_14');
    cy.wait(500);
    // Visualizo mensaje de error.
    cy.get('p[class="main-error"]').should('contain',errors.invalid_email);
    cy.screenshot('../screenshots/login_fail/before_15');
    cy.wait(500);
  })
  ...
  it('Iniciar sesión fallido con email correcto no registrado', () => {
    ...
    cy.screenshot('../screenshots/login_fail/before_16');
    cy.wait(500);
    
    // Seleccionar el campo del password e ingresar un valor.
    cy.get('input[id="password"]').type(user.invalid_password);
    cy.screenshot('../screenshots/login_fail/before_17');
    cy.wait(500);

     // Seleccioanr el boton de inicio de sesion.
     cy.get('button[type="submit"]').click();
     cy.screenshot('../screenshots/login_fail/before_18');
     cy.wait(500);

    // El boton debe contener el mensaje "Retry"
    cy.get('span[data-test-task-button-state="failure"]').should('contain','Retry');
    cy.screenshot('../screenshots/login_fail/before_19');
    cy.wait(500);
    // Visualizo mensaje de error.
    cy.get('p[class="main-error"]').should('contain', errors.incorrect_email);
    cy.screenshot('../screenshots/login_fail/before_20');
    cy.wait(500);
  })
  ...
  it('Iniciar sesión fallido con email correcto y password incorrecto', () => {
    // Seleccionar el campo del correo e ingresar un valor.
    cy.get('input[id="identification"]').type(user.email);
    cy.screenshot('../screenshots/login_fail/before_21');
    cy.wait(500);
    
    // Seleccionar el campo del password e ingresar un valor.
    cy.get('input[id="password"]').type(user.invalid_password);
    cy.screenshot('../screenshots/login_fail/before_22');
    cy.wait(500);

     // Seleccioanr el boton de inicio de sesion.
     cy.get('button[type="submit"]').click();
     cy.screenshot('../screenshots/login_fail/before_23');
     cy.wait(500);

    // El boton debe contener el mensaje "Retry"
    cy.get('span[data-test-task-button-state="failure"]').should('contain','Retry');
    cy.screenshot('../screenshots/login_fail/before_24');
    cy.wait(500);

    // Visualizo mensaje de error.
    cy.get('p[class="main-error"]').should('contain', errors.incorrect_password);
    cy.screenshot('../screenshots/login_fail/before_25');
    cy.wait(500);
  })
